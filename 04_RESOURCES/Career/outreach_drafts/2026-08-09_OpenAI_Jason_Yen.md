---
to: jasony@openai.com
cc: 
subject: Physics verification for OpenAI's physical AI systems — Mushood Hanif (Haga founder)
---
...
Your work at OpenAI in Remote (US) aligns with Haga's independent physics verification for physical AI and robotics systems.
...
**Visa**: I require **Skilled Worker sponsorship** (UK). OpenAI appears on the Home Office A-rated sponsor register.
