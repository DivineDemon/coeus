---
to: toni@shadowrobot.com
cc: 
subject: Physics verification for Shadow Robot Company Ltd.'s physical AI systems — Mushood Hanif (Haga founder)
---
...
Shadow Robot's Dexterous Hand and teleoperation systems are exactly the kind of physical AI platforms that need independent physics verification. My MuJoCo/Robosuite expertise and CogVideoX-based world model validation could strengthen your sim-to-real pipeline.
...
**Why Haga matters for Shadow Robot Company Ltd.:**
...
**Visa**: I require **Skilled Worker sponsorship** (UK). Shadow Robot Company Ltd. appears on the Home Office A-rated sponsor register.
