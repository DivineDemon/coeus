---
to: michelleh@nvidia.com
cc: 
subject: Physics verification for NVIDIA's physical AI systems — Mushood Hanif (Haga founder)
---

Hi Michelle Henderson,

I'm Mushood Hanif, founder of **Haga** — independent physics verification for physical AI and robotics systems.

Your work at NVIDIA in Remote (US-based) aligns with Haga's independent physics verification for physical AI and robotics systems.
...
**Visa**: I require **Skilled Worker sponsorship** (UK). NVIDIA appears on the Home Office A-rated sponsor register.
