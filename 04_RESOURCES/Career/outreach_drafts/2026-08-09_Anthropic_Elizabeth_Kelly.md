...
cc: 
subject: Physics verification for Anthropic's physical AI systems — Mushood Hanif (Haga founder)
---
...
Your work at Anthropic in Remote (US/UK) aligns with Haga's independent physics verification for physical AI and robotics systems.
...
**Why Haga matters for Anthropic:**
...
**Visa**: I require **Skilled Worker sponsorship** (UK). Anthropic appears on the Home Office A-rated sponsor register.
