---
to: cbussler@mistral.ai
cc: 
subject: Physics verification for Mistral AI UK Limited's physical AI systems — Mushood Hanif (Haga founder)
---

Hi Christoph Bussler,

I'm Mushood Hanif, founder of **Haga** — independent physics verification for physical AI and robotics systems.

Mistral's frontier models could benefit from physics grounding verification. Haga verifies that generated code/simulations respect physical laws — a growing need for coding agents.
...
**Why Haga matters for Mistral AI UK Limited:**
...
**Visa**: I require **Skilled Worker sponsorship** (UK). Mistral AI UK Limited appears on the Home Office A-rated sponsor register.
