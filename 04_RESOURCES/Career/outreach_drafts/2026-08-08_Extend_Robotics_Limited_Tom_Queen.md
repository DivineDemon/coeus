---
to: tom.queen@extendrobotics.com
cc: 
subject: Physics verification for Extend Robotics Limited's physical AI systems — Mushood Hanif (Haga founder)
---
...
Extend's human-robot interface and teleoperation systems benefit from physics consistency checks — ensuring the sim matches the operator's mental model.
...
**Why Haga matters for Extend Robotics Limited:**
...
**Visa**: I require **Skilled Worker sponsorship** (UK). Extend Robotics Limited appears on the Home Office A-rated sponsor register.
