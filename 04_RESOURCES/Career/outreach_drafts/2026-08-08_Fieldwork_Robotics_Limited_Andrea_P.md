---
to: andrea@fieldworkrobotics.com
cc: 
subject: Physics verification for Fieldwork Robotics Limited's physical AI systems — Mushood Hanif (Haga founder)
---
...
Fieldwork's agricultural robotics (raspberry picking etc.) need robust sim-to-real. My MuJoCo expertise and physics consistency checks for deformable object manipulation directly apply.
...
**Why Haga matters for Fieldwork Robotics Limited:**
...
**Visa**: I require **Skilled Worker sponsorship** (UK). Fieldwork Robotics Limited appears on the Home Office A-rated sponsor register.
