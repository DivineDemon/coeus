---
to: ciarabrannigan@meta.com
cc: 
subject: Physics verification for Meta AI (FAIR)'s physical AI systems — Mushood Hanif (Haga founder)
---
...
Your work at Meta AI (FAIR) in Remote (US/UK) aligns with Haga's independent physics verification for physical AI and robotics systems.
...
**Why Haga matters for Meta AI (FAIR):**
...
**Visa**: I require **Skilled Worker sponsorship** (UK). Meta AI (FAIR) appears on the Home Office A-rated sponsor register.
