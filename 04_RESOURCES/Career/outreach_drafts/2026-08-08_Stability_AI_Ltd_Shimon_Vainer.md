---
to: shimon.vainer@stability.ai
cc: 
subject: Physics verification for Stability AI Ltd's physical AI systems — Mushood Hanif (Haga founder)
---
...
Stability's video generation (Stable Video Diffusion) and 3D assets need physics consistency. CogVideoX verification expertise directly applies to ensuring generated dynamics are physically plausible.
...
**Why Haga matters for Stability AI Ltd:**
...
**Visa**: I require **Skilled Worker sponsorship** (UK). Stability AI Ltd appears on the Home Office A-rated sponsor register.
