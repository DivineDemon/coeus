---
to: lucia.roca@perceptualrobotics.com
cc: 
subject: Physics verification for Perceptual Robotics Limited's physical AI systems — Mushood Hanif (Haga founder)
---
...
Perceptual's wind turbine inspection drones need verified physics for GPS-denied navigation. My simulation verification ensures world models match real aerodynamics.
...
**Why Haga matters for Perceptual Robotics Limited:**
...
**Visa**: I require **Skilled Worker sponsorship** (UK). Perceptual Robotics Limited appears on the Home Office A-rated sponsor register.
