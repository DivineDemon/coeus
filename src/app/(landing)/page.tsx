...
import { Check, Star, Verified, Waypoints } from "lucide-react";
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
                ...
                <div className="relative min-h-[30rem] w-full grow p-7 [container-type:inline-size] max-lg:mx-auto max-lg:max-w-sm">
                  ...
                  <div className="absolute left-0 top-10 z-0 size-36 rounded-full bg-purple-500/50 blur-[50px]" />
                  <Image
            ...
            <div className="relative max-lg:row-start-1">
              ...
              <div className="relative flex h-full flex-col gap-5 overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
                <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                  ...
                  <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                    Ask the Coeus AI questions about your code and find answers
                    to your questions.
                  </p>
                </div>
            ...
            <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
              ...
              <div className="relative flex h-full flex-col gap-5 overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
                <div className="px-8 pt-8 sm:px-10 sm:pt-10">
                  ...
                  <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                    Onboard new members onto your team with ease. Employ Coeus
                    AI to introduce your team members to your codebase.
                  </p>
                </div>
                <div className="flex flex-1 items-center justify-center px-8 max-lg:pb-12 max-lg:pt-10 sm:px-10 lg:pb-2">
                  <Image
            ...
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                ...
                <div className="relative min-h-[30rem] w-full grow p-7 [container-type:inline-size] max-lg:mx-auto max-lg:max-w-sm">
                  ...
                  <div className="absolute right-0 top-10 z-0 size-36 rounded-full bg-purple-500/50 blur-[50px]" />
                  <Image
                    src={Track}
                    alt="track"
                    className="size-full object-contain"
        ...
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 divide-y divide-gray-200 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:divide-x lg:divide-y-0">
            <div className="flex flex-auto flex-col gap-4 rounded-t-[2rem] bg-gray-50 p-6 sm:p-8 lg:rounded-l-[2rem] lg:rounded-tr-none lg:p-16">
              ...
              <p className="text-pretty text-center text-base font-medium tracking-tight text-blue-950 sm:text-lg lg:text-left lg:text-lg/8">
                Coeus has been a gamechanger for me. I&apos;ve been using it for
                2 months now and seeing team performance increase in real-time
                is super satisfying.
              </p>
            ...
            <div className="flex flex-auto flex-col gap-4 rounded-b-[2rem] bg-gray-50 p-6 sm:p-8 lg:rounded-r-[2rem] lg:rounded-bl-none lg:p-16">
              ...
              <p className="text-pretty text-center text-base font-medium tracking-tight text-blue-950 sm:text-lg lg:text-left lg:text-lg/8">
                Coeus has been paying off for our team. Nice to have a simple
                way of seeing how we&apos;re doing day-to-day. Definitely makes
                our lives easier.
              </p>
              <div className="mt-2 flex flex-col items-center justify-center gap-4 sm:flex-row sm:items-start lg:justify-start">
                <Image
